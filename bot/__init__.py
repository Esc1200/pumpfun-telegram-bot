"""
Telegram pump.fun trading bot — main bot with command handlers.
"""
...
class PumpFunBot:
    def __init__(self):
        ...
        self.clients: Dict[int, PumpFunClient] = {}  # user_id -> client
        self.tracker_tasks: Dict[int, asyncio.Task] = {}  # user_id -> tracker task
